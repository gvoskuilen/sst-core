...
#ifndef _H_SST_CORE_STATISTICS_OUTPUT_SIM_STAT
#define _H_SST_CORE_STATISTICS_OUTPUT_SIM_STAT
...
/**
    \class StatisticOutputSimStat

    The class for statistics output to a JSON formatted file per the 
    SimStat schema
*/
class StatisticOutputSimStat : public StatisticFieldsOutput
{
public:
    SST_ELI_REGISTER_DERIVED(
        StatisticOutput,
        StatisticOutputSimStat,
        "sst",
        "statoutputsimstat",
        SST_ELI_ELEMENT_VERSION(1,0,0),
        "Output to a JSON file")

    /** Construct a StatOutputSimStat
     * @param outputParameters - Parameters used for this Statistic Output
     */
    StatisticOutputSimStat(Params& outputParameters);
...
protected:
    StatisticOutputSimStat() {;} // For serialization
